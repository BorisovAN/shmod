from matching.roma.models.matcher import *
from matching.roma.models.transformer import Block, TransformerDecoder, MemEffAttention
from matching.roma.models.encoders import *
from matching.roma.models.tiny import TinyRoMa
...
def roma_model(resolution, upsample_preds, device = None, weights=None, dinov2_weights=None, amp_dtype: torch.dtype=torch.float16, **kwargs):
    ...
    decoder = Decoder(coordinate_decoder, 
                      ...
                      gm_warp_dropout_p = gm_warp_dropout_p, amp_dtype=amp_dtype)
